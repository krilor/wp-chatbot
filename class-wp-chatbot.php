...
class WP_Chatbot {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( __FILE__ ) . 'class-wp-chatbot-loader.php';
		 ...
		 */
		require_once plugin_dir_path( __FILE__ ) . 'class-wp-chatbot-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( __FILE__ ) . 'class-wp-chatbot-public.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new WP_Chatbot_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new WP_Chatbot_Public( $this->get_plugin_name(), $this->get_version() );
